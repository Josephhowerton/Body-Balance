...
@Dark
@Composable
private fun NutritionPreferencesPreview() = BodyBalanceTheme {
    Surface {
...
@Composable
fun NutritionPreferences(onTriggerEvent: (NutritionEvent) -> Unit = {}) = ConstraintLayout(modifier = Modifier.fillMaxSize()) {
    ...
    val preferences = remember { mutableListOf<ENutritionPreferences>() }
    ...
    LazyVerticalGrid(
        ...
        items(ENutritionPreferences.values()) {
            PreferenceItem(it, onClick = {
    ...
    AnimatedVisibility(
        ...
        Card(
            ...
            Column(
                ...
                StandardTitleText(
                    text = R.string.title_nutritional_preferences,
                ...
                StandardTextSmall(
                    text = R.string.desc_nutritional_preferences,
    ...
    AnimatedVisibility(
        ...
        Button(
            onClick = { onTriggerEvent(NutritionEvent.NutritionPreferences(preferences = preferences)) },
            modifier = Modifier
                .shadow(
                    elevation = 5.dp,
                    shape = CircleShape,
...
@Composable
fun PreferenceItem(
    restrictions: ENutritionPreferences,
    onClick:() -> Unit,
