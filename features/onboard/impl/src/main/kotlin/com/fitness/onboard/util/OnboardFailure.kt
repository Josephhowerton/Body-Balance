...
sealed class OnboardFailure : Failure() {
    data class UnknownFailure(override val description: Int = 1, override val title: Int = 2) : OnboardFailure()
    data class SystemFailure(override val description: Int = 1, override val title: Int = 2) : OnboardFailure()
    data class UserFailure(override val description: Int = 1, override val title: Int = 2) : OnboardFailure()
}
