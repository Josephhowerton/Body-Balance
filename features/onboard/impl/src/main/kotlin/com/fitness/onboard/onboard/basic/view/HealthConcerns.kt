...
@Dark
@Composable
private fun HealthConcernsPreview() = BodyBalanceTheme {
    Surface {
        HealthConcerns(BasicInformationState())
    }
}
...
fun HealthConcerns(
    ...
    LazyVerticalGrid(
        ...
        items(40) {
            TextItemComponent("Health Concerns", onClick = { Log.e("DietaryPreferences", it) })
        }
    }
    ...
    AnimatedVisibility(
        ...
        Card(
            ...
            Column(
                ...
                StandardTitleText(
                    text = R.string.title_health_concerns,
                ...
                StandardTextSmall(
                    text = R.string.desc_health_concerns,
